...
<span class:panel class="sultan-offer" aria-label={label} data-component="SultanOffer">
  ...
  <svg class="offer-arrow" aria-hidden="true" viewBox="0 0 16 16"><path d="M2 8h11M9 4l4 4-4 4" /></svg><span class="ruby-reward"><GameArt kind="component" component="ruby" /></span>
</span>
...
<style>
  ...
  .offer-arrow { width: 1rem; height: 1rem; overflow: visible; color: #7c5127; fill: none; stroke: currentColor; stroke-width: 1.75; stroke-linecap: round; stroke-linejoin: round; }
  ...
  .sultan-offer.panel .sultan-cost { gap: .22rem; }.sultan-offer.panel .sultan-cost > span { width: min(100%, 3rem); }.sultan-offer.panel .sultan-cost :global(.game-art), .sultan-offer.panel .any-good { width: 1.65rem; height: 1.65rem; }.sultan-offer.panel .ruby-reward :global(.game-art) { width: 2.2rem; height: 2.2rem; }.sultan-offer.panel .offer-arrow { width: 1.5rem; height: 1.5rem; }
  @media (max-width: 960px) {
    .sultan-offer:not(.panel) { width: 100%; height: 1.15rem; grid-template-columns: minmax(0, 1fr) auto .45rem; gap: .03rem; padding: .06rem; border-width: 1px; border-radius: .18rem; }.sultan-offer:not(.panel) .sultan-cost { gap: .02rem; }.sultan-offer:not(.panel) .sultan-cost > span { width: min(100%, .86rem); border-radius: .07rem; }.sultan-offer:not(.panel) .sultan-cost :global(.game-art), .sultan-offer:not(.panel) .any-good { width: .38rem; height: .38rem; }.sultan-offer:not(.panel) b { min-width: .25rem; padding: .02rem; font-size: .19rem; }.sultan-offer:not(.panel) .any-good { gap: .015rem; padding: .03rem; }.sultan-offer:not(.panel) .offer-arrow { width: .35rem; height: .35rem; }.sultan-offer:not(.panel) .ruby-reward :global(.game-art) { width: .45rem; height: .45rem; }
  }
  @media (max-width: 720px) {
    .sultan-offer.panel { height: 2.4rem; grid-template-columns: minmax(0, 1fr) auto 1.3rem; gap: .12rem; margin: .1rem 0; padding: .16rem; }.sultan-offer.panel .sultan-cost { gap: .08rem; }.sultan-offer.panel .sultan-cost > span { width: min(100%, 1.8rem); }.sultan-offer.panel .sultan-cost :global(.game-art), .sultan-offer.panel .any-good { width: 1rem; height: 1rem; }.sultan-offer.panel .ruby-reward :global(.game-art) { width: 1.25rem; height: 1.25rem; }.sultan-offer.panel .offer-arrow { width: .85rem; height: .85rem; }
  }
</style>
